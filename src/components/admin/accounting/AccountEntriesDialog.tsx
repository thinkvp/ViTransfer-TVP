              ...
              <tfoot>
                {openingBalanceCents !== null && (
                  <tr className="border-t-2 border-border bg-muted/20">
                    ...
                    <td className="px-4 py-2.5 text-right tabular-nums text-muted-foreground whitespace-nowrap">{fmtAud(openingBalanceCents)}</td>
                  </tr>
                )}
                ...
                {openingBalanceCents !== null && (
                  <tr className="border-t border-border bg-muted/50">
                    <td colSpan={4} className="px-4 py-2.5 text-right text-sm font-semibold text-foreground">Balance</td>
                    <td className="px-4 py-2.5 text-right tabular-nums font-semibold text-foreground whitespace-nowrap">{fmtAud(periodTotalCents + openingBalanceCents)}</td>
                  </tr>
                )}
              </tfoot>
            </table>
