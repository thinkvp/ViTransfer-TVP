  ...
  try {
    ...
    const settings = await prisma.pushNotificationSettings.upsert({
      ...
      update: {
        ...
        notifyCommentReactions: body.notifyCommentReactions ?? true,
        notifyInternalComments: body.notifyInternalComments ?? true,
        notifyTaskComments: body.notifyTaskComments ?? true,
        notifyVideoApproval: body.notifyVideoApproval ?? true,
        notifyUserAssignments: body.notifyUserAssignments ?? true,
        ...
        notifySalesReminders: body.notifySalesReminders ?? true,
