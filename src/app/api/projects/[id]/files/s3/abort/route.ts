/**
 * POST /api/projects/[id]/files/s3/abort
 *
 * Aborts an in-progress multipart upload for a project file, releasing stored
...
export async function POST(
  ...
  try {
    ...
    console.error('[PROJECT FILES S3 ABORT] Failed to abort multipart upload:', err)
