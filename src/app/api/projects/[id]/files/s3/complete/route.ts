...
export async function POST(
  ...
  // can't leave a ProjectFile without its registration.
  let record
  try {
    ...
    console.error(`[PROJECT FILES S3 COMPLETE] Upload completed but DB registration failed — unregistered object at ${key}:`, err)
