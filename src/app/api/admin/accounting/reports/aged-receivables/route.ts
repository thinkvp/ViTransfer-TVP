...
import { buildAgedReceivablesReport } from '@/lib/accounting/reports'

export const runtime = 'nodejs'
export const dynamic = 'force-dynamic'

// GET /api/admin/accounting/reports/aged-receivables?asOf=YYYY-MM-DD
