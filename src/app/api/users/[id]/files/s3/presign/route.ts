/**
 * POST /api/users/[id]/files/s3/presign
 *
 * Initiates a browser-direct multipart upload to S3/R2 for a user file,
...
export async function POST(
  ...
  try {
    ...
    console.error('[USER FILES S3 PRESIGN] Failed to initiate multipart upload:', err)
