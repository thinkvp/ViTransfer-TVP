...
import { createQuote, getSalesSettings, getTodayYmd } from '@/lib/sales/local-store'
    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Draft a quote and link it to a client/project.</p>
        </div>
      ...
      <div className="flex justify-end gap-2">
        <Button variant="default" onClick={onCreate}>Create quote</Button>
      </div>
    </div>
  )
}
