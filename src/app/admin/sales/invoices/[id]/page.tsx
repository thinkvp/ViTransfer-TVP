...
import type { SalesInvoiceWithVersion, SalesItem, SalesLabel, SalesRollupResponse } from '@/lib/sales/admin-api'
...
export default function InvoiceDetailPage() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      try {
        const [s, inv, pay, r, rates] = await Promise.all([
          fetchSalesSettings(),
  ...
  const docTaxEnabled = invoice?.taxEnabled ?? settings.taxEnabled
