...
export const RATE_LIMIT_ALERT_NOTIFICATION_TYPE = 'RATE_LIMIT_ALERT'
export const VEHICLE_ODOMETER_REMINDER_NOTIFICATION_TYPE = 'VEHICLE_ODOMETER_REMINDER'
export const BAS_DUE_REMINDER_NOTIFICATION_TYPE = 'BAS_DUE_REMINDER'
export const S3_LOCAL_BACKUP_FAILURE_NOTIFICATION_TYPE = 'S3_LOCAL_BACKUP_FAILURE'
